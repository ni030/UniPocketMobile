...
const ReportFeedback = () => {
    ...
    const [reportDetailsExpanded, setReportDetailsExpanded] = useState(true);
    const [cancelAvaliable, setCancelAvaliable] = useState(false);
    const [completeAvaliable, setCompleteAvaliable] = useState(true);
  return (
        ...
        <ScrollView className='w-full h-3/5 bg-white rounded-xl border-2 border-gray-200 p-8'>
            ...
            <View className='w-full h-auto my-2 flex justify-start items-left'>
                ...
                <View className='w-full h-auto p-2 my-4 flex flex-row justify-center items-center gap-3'>
                    ...
                    <TouchableOpacity className={`h-auto w-1/2 rounded-lg ${completeAvaliable ? 'bg-rose-800' : 'bg-gray-300'}`}>                        
